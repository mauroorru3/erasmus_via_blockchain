...
func CmdInsertStudentPersonalInfo() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "insert-student-personal-info [university] [student-index] [gender] [date-of-birth] [primary-nationality] [country-of-birth] [province-of-birth] [town-of-birth] [tax-code]",
