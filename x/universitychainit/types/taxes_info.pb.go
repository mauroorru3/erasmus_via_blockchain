...
type TaxesInfo struct {
	...
	TaxesHistory *AnnualTaxes `protobuf:"bytes,3,opt,name=taxesHistory,proto3" json:"taxesHistory,omitempty"`
}
...
func (m *TaxesInfo) GetTaxesHistory() *AnnualTaxes {
	if m != nil {
...
var fileDescriptor_409477814400c378 = []byte{
	...
	,
}
...
func (m *TaxesInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TaxesHistory != nil {
		{
			size, err := m.TaxesHistory.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
			i = encodeVarintTaxesInfo(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x1a
	}
...
func (m *TaxesInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.TaxesHistory == nil {
				m.TaxesHistory = &AnnualTaxes{}
			}
			if err := m.TaxesHistory.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
