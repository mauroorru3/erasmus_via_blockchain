...
type TranscriptOfRecords struct {
	ExamsData       *ExamsInfo `protobuf:"bytes,1,opt,name=examsData,proto3" json:"examsData,omitempty"`
	TotalExams      uint64     `protobuf:"varint,2,opt,name=totalExams,proto3" json:"totalExams,omitempty"`
	ExamsPassed     uint64     `protobuf:"varint,3,opt,name=examsPassed,proto3" json:"examsPassed,omitempty"`
	TotalCredits    uint64     `protobuf:"varint,4,opt,name=totalCredits,proto3" json:"totalCredits,omitempty"`
	AchievedCredits uint64     `protobuf:"varint,5,opt,name=achievedCredits,proto3" json:"achievedCredits,omitempty"`
}
...
func (m *TranscriptOfRecords) GetExamsData() *ExamsInfo {
	if m != nil {
		return m.ExamsData
	}
	return nil
...
func (m *TranscriptOfRecords) GetTotalExams() uint64 {
	if m != nil {
		return m.TotalExams
	}
	return 0
...
func (m *TranscriptOfRecords) GetExamsPassed() uint64 {
	if m != nil {
...
func (m *TranscriptOfRecords) GetTotalCredits() uint64 {
	if m != nil {
...
func (m *TranscriptOfRecords) GetAchievedCredits() uint64 {
	if m != nil {
...
var fileDescriptor_3a2a811304e2eae7 = []byte{
	...
	,
}
	...
	if m.ExamsData != nil {
		{
			...
			i -= size
			i = encodeVarintTranscriptOfRecords(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
