...
import (
	...
	"university_chain_it/docs"
	universitychainitmodule "university_chain_it/x/universitychainit"
	universitychainitmodulekeeper "university_chain_it/x/universitychainit/keeper"
	universitychainitmoduletypes "university_chain_it/x/universitychainit/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "cosmos"
	Name                 = "university_chain_it"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		universitychainitmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	UniversitychainitKeeper       universitychainitmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		universitychainitmoduletypes.StoreKey,
	...
	app.UniversitychainitKeeper = *universitychainitmodulekeeper.NewKeeper(
		...
		app.GetSubspace(universitychainitmoduletypes.ModuleName),
		app.IBCKeeper.ChannelKeeper,
		&app.IBCKeeper.PortKeeper,
		scopedUniversitychainitKeeper,
	)
	universitychainitModule := universitychainitmodule.NewAppModule(appCodec, app.UniversitychainitKeeper, app.AccountKeeper, app.BankKeeper)
	...
	ibcRouter.AddRoute(universitychainitmoduletypes.ModuleName, universitychainitModule)
	...
	app.mm.SetOrderBeginBlockers(
		...
		universitychainitmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(universitychainitmoduletypes.ModuleName)
